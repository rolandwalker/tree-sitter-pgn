...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 2129:
      if (lookahead == '\n' ||
          lookahead == '\r') SKIP(2129);
      if (('\t' <= lookahead && lookahead <= '\f') ||
          lookahead == ' ') ADVANCE(2239);
      if ((!eof && set_contains(sym_tagpair_key_character_set_1, 22, lookahead))) ADVANCE(2240);
      END_STATE();
    case 2130:
      if (lookahead == 'A' ||
...
static const TSLexMode ts_lex_modes[STATE_COUNT] = {
  ...
  [19] = {.lex_state = 1109, .external_lex_state = 1},
  [20] = {.lex_state = 1110, .external_lex_state = 1},
  [21] = {.lex_state = 1109, .external_lex_state = 1},
  [22] = {.lex_state = 1082, .external_lex_state = 1},
  [23] = {.lex_state = 1109, .external_lex_state = 1},
  ...
  [40] = {.lex_state = 1109, .external_lex_state = 1},
  [41] = {.lex_state = 2187, .external_lex_state = 1},
  [42] = {.lex_state = 1108, .external_lex_state = 1},
  ...
  [69] = {.lex_state = 1108, .external_lex_state = 1},
  [70] = {.lex_state = 1108, .external_lex_state = 1},
  [71] = {.lex_state = 1108, .external_lex_state = 1},
  [72] = {.lex_state = 1082, .external_lex_state = 1},
  [73] = {.lex_state = 1082, .external_lex_state = 1},
  [74] = {.lex_state = 1108, .external_lex_state = 1},
  [75] = {.lex_state = 1082, .external_lex_state = 1},
  [76] = {.lex_state = 1108, .external_lex_state = 1},
  ...
  [84] = {.lex_state = 1108, .external_lex_state = 1},
  [85] = {.lex_state = 1108, .external_lex_state = 1},
  ...
  [95] = {.lex_state = 1108, .external_lex_state = 1},
  ...
  [100] = {.lex_state = 1108, .external_lex_state = 1},
  ...
  [120] = {.lex_state = 1115},
  [121] = {.lex_state = 1160},
  [122] = {.lex_state = 1106, .external_lex_state = 1},
  [123] = {.lex_state = 1107, .external_lex_state = 1},
  [124] = {.lex_state = 1107, .external_lex_state = 1},
  [125] = {.lex_state = 1107, .external_lex_state = 1},
  ...
  [132] = {.lex_state = 1107, .external_lex_state = 1},
