  ...
  switch (state) {
    case 0:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(2272);
      if (('3' <= lookahead && lookahead <= '8')) ADVANCE(2385);
      if (('a' <= lookahead && lookahead <= 'h')) ADVANCE(2381);
      if (lookahead == 'B' ||
          lookahead == 'K' ||
          ('N' <= lookahead && lookahead <= 'R') ||
          (0x2654 <= lookahead && lookahead <= 0x265e)) ADVANCE(2386);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(1207);
      END_STATE();
    ...
    case 38:
      ...
      if (lookahead == 0x221e) ADVANCE(2439);
      if (lookahead != 0) ADVANCE(866);
      END_STATE();
    case 39:
      if (lookahead == '\n') ADVANCE(1207);
    ...
    case 40:
      ...
      if (lookahead == 0xbd) ADVANCE(2527);
      if (lookahead != 0) ADVANCE(866);
      END_STATE();
    case 41:
      if (lookahead == '\n') ADVANCE(1207);
    ...
    case 821:
      if (lookahead == '\n') ADVANCE(1207);
      if (lookahead == '\r') ADVANCE(1);
      if (lookahead == 0xfe0e) ADVANCE(2411);
      if (lookahead != 0) ADVANCE(866);
      END_STATE();
    case 822:
      if (lookahead == '\n') ADVANCE(1207);
    ...
    case 865:
      if (lookahead == '\n') ADVANCE(1207);
      if (lookahead == '\r') ADVANCE(1);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(2438);
      if (lookahead != 0) ADVANCE(866);
      END_STATE();
    case 866:
      if (lookahead == '\n') ADVANCE(1207);
    ...
    case 872:
      ...
      if (lookahead == '-' ||
          (0x2010 <= lookahead && lookahead <= 0x2014) ||
          lookahead == 0x2212 ||
          lookahead == 0x2796) ADVANCE(2434);
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(868);
      if (lookahead == 'B' ||
          lookahead == 'K' ||
          lookahead == 'Q' ||
          (0x2654 <= lookahead && lookahead <= 0x265e)) ADVANCE(2392);
      if (set_contains(sym_annotation_character_set_6, 53, lookahead)) ADVANCE(2439);
      if (lookahead != 0) ADVANCE(866);
      END_STATE();
    case 873:
      ADVANCE_MAP(
    ...
    case 1114:
      ...
      if (lookahead == '-' ||
          (0x2010 <= lookahead && lookahead <= 0x2014) ||
          lookahead == 0x2212 ||
          lookahead == 0x2796) ADVANCE(2444);
      if (('2' <= lookahead && lookahead <= '9')) ADVANCE(2262);
      if (lookahead == 'B' ||
          lookahead == 'K' ||
          lookahead == 'Q' ||
          (0x2654 <= lookahead && lookahead <= 0x265e)) ADVANCE(2390);
      if (set_contains(sym_annotation_character_set_6, 53, lookahead)) ADVANCE(2429);
      END_STATE();
    case 1115:
      ADVANCE_MAP(
        '\n', 1117,
    ...
    case 1187:
      ...
      if (lookahead == 0xbd) ADVANCE(2526);
      END_STATE();
    case 1188:
      if (lookahead == '&') ADVANCE(1165);
    ...
    case 1195:
      ...
      if (lookahead == 0x221e) ADVANCE(2429);
      END_STATE();
    case 1196:
      ADVANCE_MAP(
        '&', 1171,
    ...
    case 1221:
      ...
      END_STATE();
    case 1222:
      if (lookahead == '0') ADVANCE(2474);
      if (lookahead == '@') ADVANCE(2412);
      if (lookahead == 'O') ADVANCE(2470);
      if (lookahead == 'o') ADVANCE(2479);
      if (lookahead == ':' ||
          lookahead == 'X' ||
          lookahead == 'x') ADVANCE(2396);
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(1223);
      if (('1' <= lookahead && lookahead <= '8')) ADVANCE(2385);
      if (('a' <= lookahead && lookahead <= 'h')) ADVANCE(2381);
      END_STATE();
    case 1223:
      if (lookahead == '0') ADVANCE(2474);
    ...
    case 2206:
      ...
      END_STATE();
    case 2207:
      if (lookahead == 0xfe0e) ADVANCE(2410);
      END_STATE();
    case 2208:
      if (lookahead == 'A' ||
    ...
    case 2263:
      ...
      END_STATE();
    case 2264:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(2449);
      END_STATE();
    case 2265:
      if (eof) ADVANCE(2273);
      ADVANCE_MAP(
...
static const TSLexMode ts_lex_modes[STATE_COUNT] = {
  ...
  [12] = {.lex_state = 2268, .external_lex_state = 1},
  [13] = {.lex_state = 2269, .external_lex_state = 1},
  [14] = {.lex_state = 2269, .external_lex_state = 1},
  [15] = {.lex_state = 2269, .external_lex_state = 1},
  [16] = {.lex_state = 2269, .external_lex_state = 1},
  [17] = {.lex_state = 1142, .external_lex_state = 1},
  [18] = {.lex_state = 2267, .external_lex_state = 1},
  [19] = {.lex_state = 2267, .external_lex_state = 1},
  [20] = {.lex_state = 2270, .external_lex_state = 1},
  [21] = {.lex_state = 2270, .external_lex_state = 1},
  [22] = {.lex_state = 2267, .external_lex_state = 1},
  [23] = {.lex_state = 1142, .external_lex_state = 1},
  [24] = {.lex_state = 2267, .external_lex_state = 1},
  [25] = {.lex_state = 1143, .external_lex_state = 1},
  [26] = {.lex_state = 1143, .external_lex_state = 1},
  [27] = {.lex_state = 2267, .external_lex_state = 1},
  [28] = {.lex_state = 2267, .external_lex_state = 1},
  [29] = {.lex_state = 1143, .external_lex_state = 1},
  [30] = {.lex_state = 2267, .external_lex_state = 1},
  [31] = {.lex_state = 2265, .external_lex_state = 1},
  [32] = {.lex_state = 2267, .external_lex_state = 1},
  [33] = {.lex_state = 2267, .external_lex_state = 1},
  [34] = {.lex_state = 2267, .external_lex_state = 1},
  [35] = {.lex_state = 2267, .external_lex_state = 1},
  [36] = {.lex_state = 2267, .external_lex_state = 1},
  [37] = {.lex_state = 2267, .external_lex_state = 1},
  ...
  [42] = {.lex_state = 2267, .external_lex_state = 1},
  [43] = {.lex_state = 2267, .external_lex_state = 1},
  [44] = {.lex_state = 2267, .external_lex_state = 1},
  [45] = {.lex_state = 2267, .external_lex_state = 1},
  [46] = {.lex_state = 1143, .external_lex_state = 1},
  [47] = {.lex_state = 2267, .external_lex_state = 1},
  [48] = {.lex_state = 2267, .external_lex_state = 1},
  [49] = {.lex_state = 2267, .external_lex_state = 1},
  [50] = {.lex_state = 2267, .external_lex_state = 1},
  [51] = {.lex_state = 2267, .external_lex_state = 1},
  [52] = {.lex_state = 2265, .external_lex_state = 1},
  [53] = {.lex_state = 2267, .external_lex_state = 1},
  [54] = {.lex_state = 2267, .external_lex_state = 1},
  [55] = {.lex_state = 2267, .external_lex_state = 1},
  [56] = {.lex_state = 1141, .external_lex_state = 1},
  [57] = {.lex_state = 2267, .external_lex_state = 1},
  ...
  [96] = {.lex_state = 1141, .external_lex_state = 1},
  ...
  [104] = {.lex_state = 1141, .external_lex_state = 1},
  [105] = {.lex_state = 1141, .external_lex_state = 1},
  [106] = {.lex_state = 1141, .external_lex_state = 1},
  [107] = {.lex_state = 1141, .external_lex_state = 1},
  [108] = {.lex_state = 1141, .external_lex_state = 1},
  [109] = {.lex_state = 1141, .external_lex_state = 1},
  [110] = {.lex_state = 1141, .external_lex_state = 1},
  [111] = {.lex_state = 2271, .external_lex_state = 1},
  [112] = {.lex_state = 2271, .external_lex_state = 1},
  [113] = {.lex_state = 2271, .external_lex_state = 1},
  [114] = {.lex_state = 1148},
  [115] = {.lex_state = 2271, .external_lex_state = 1},
  [116] = {.lex_state = 2271, .external_lex_state = 1},
  [117] = {.lex_state = 1147},
  [118] = {.lex_state = 1148},
  [119] = {.lex_state = 0},
  [120] = {.lex_state = 1148},
  ...
  [125] = {.lex_state = 1196},
  [126] = {.lex_state = 1196},
  [127] = {.lex_state = 2270, .external_lex_state = 1},
  [128] = {.lex_state = 2270, .external_lex_state = 1},
  [129] = {.lex_state = 2270, .external_lex_state = 1},
  [130] = {.lex_state = 1196},
  [131] = {.lex_state = 1196},
  [132] = {.lex_state = 1139, .external_lex_state = 1},
  [133] = {.lex_state = 1196},
  [134] = {.lex_state = 2270, .external_lex_state = 1},
  [135] = {.lex_state = 1139, .external_lex_state = 1},
  [136] = {.lex_state = 1140, .external_lex_state = 1},
  [137] = {.lex_state = 1140, .external_lex_state = 1},
  [138] = {.lex_state = 1140, .external_lex_state = 1},
  [139] = {.lex_state = 2271, .external_lex_state = 1},
  [140] = {.lex_state = 2266, .external_lex_state = 1},
  [141] = {.lex_state = 1140, .external_lex_state = 1},
  [142] = {.lex_state = 2270, .external_lex_state = 1},
  [143] = {.lex_state = 2270, .external_lex_state = 1},
  [144] = {.lex_state = 2270, .external_lex_state = 1},
  [145] = {.lex_state = 2270, .external_lex_state = 1},
  [146] = {.lex_state = 2270, .external_lex_state = 1},
  [147] = {.lex_state = 2270, .external_lex_state = 1},
  [148] = {.lex_state = 2270, .external_lex_state = 1},
  [149] = {.lex_state = 2270, .external_lex_state = 1},
  [150] = {.lex_state = 2270, .external_lex_state = 1},
  [151] = {.lex_state = 2270, .external_lex_state = 1},
  [152] = {.lex_state = 2270, .external_lex_state = 1},
  [153] = {.lex_state = 2270, .external_lex_state = 1},
  [154] = {.lex_state = 2270, .external_lex_state = 1},
  [155] = {.lex_state = 2266, .external_lex_state = 1},
  ...
  [160] = {.lex_state = 2271, .external_lex_state = 1},
  [161] = {.lex_state = 2271, .external_lex_state = 1},
  [162] = {.lex_state = 2271, .external_lex_state = 1},
  [163] = {.lex_state = 2270, .external_lex_state = 1},
  [164] = {.lex_state = 2271, .external_lex_state = 1},
  [165] = {.lex_state = 2270, .external_lex_state = 1},
  [166] = {.lex_state = 1126, .external_lex_state = 1},
  [167] = {.lex_state = 1196},
  [168] = {.lex_state = 2271, .external_lex_state = 1},
  [169] = {.lex_state = 2270, .external_lex_state = 1},
  [170] = {.lex_state = 2271, .external_lex_state = 1},
  [171] = {.lex_state = 2271, .external_lex_state = 1},
  [172] = {.lex_state = 2271, .external_lex_state = 1},
  [173] = {.lex_state = 1196},
  [174] = {.lex_state = 2270, .external_lex_state = 1},
  ...
  [180] = {.lex_state = 2271, .external_lex_state = 1},
  [181] = {.lex_state = 2271, .external_lex_state = 1},
  ...
  [186] = {.lex_state = 2271, .external_lex_state = 1},
  [187] = {.lex_state = 2271, .external_lex_state = 1},
  [188] = {.lex_state = 2271, .external_lex_state = 1},
  [189] = {.lex_state = 2271, .external_lex_state = 1},
  [190] = {.lex_state = 2271, .external_lex_state = 1},
  [191] = {.lex_state = 2271, .external_lex_state = 1},
  [192] = {.lex_state = 2271, .external_lex_state = 1},
  [193] = {.lex_state = 2271, .external_lex_state = 1},
  [194] = {.lex_state = 2271, .external_lex_state = 1},
  [195] = {.lex_state = 2271, .external_lex_state = 1},
  [196] = {.lex_state = 2271, .external_lex_state = 1},
  [197] = {.lex_state = 2271, .external_lex_state = 1},
  [198] = {.lex_state = 0},
  [199] = {.lex_state = 2206},
  [200] = {.lex_state = 2206},
  [201] = {.lex_state = 2206},
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [813] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tagpair_delimiter_open, 1, 0, 0),
  ...
  [820] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_tagpair_delimiter_open_repeat1, 2, 0, 0),
