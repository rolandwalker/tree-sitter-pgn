...
enum {
  ...
  sym_lan_move = 92,
  sym__san_square = 93,
  sym__san_promotion = 94,
  sym__san_move_pawn = 95,
  sym__san_drop_pawn = 96,
  sym__san_move_major_or_minor_piece = 97,
  sym__san_drop_major_or_minor_piece = 98,
  sym__lan_move_by_coordinates = 99,
  sym_result_code = 100,
  aux_sym_series_of_games_repeat1 = 101,
  aux_sym_freestanding_comment_repeat1 = 102,
  aux_sym_header_repeat1 = 103,
  aux_sym_tagpair_value_contents_repeat1 = 104,
  aux_sym_movetext_repeat1 = 105,
  aux_sym_variation_movetext_repeat1 = 106,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [21] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_movetext_repeat1, 2, .production_id = 28), SHIFT_REPEAT(147),
  [24] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_movetext_repeat1, 2, .production_id = 28), SHIFT_REPEAT(39),
  ...
  [33] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_movetext_repeat1, 2, .production_id = 28), SHIFT_REPEAT(153),
  [36] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_movetext_repeat1, 2, .production_id = 28), SHIFT_REPEAT(129),
  [39] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_movetext_repeat1, 2, .production_id = 28), SHIFT_REPEAT(15),
  ...
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__san_move_major_or_minor_piece, 5),
  [127] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__san_move_major_or_minor_piece, 5),
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rest_of_line_comment, 2, .production_id = 6),
  [131] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rest_of_line_comment, 2, .production_id = 6),
  [133] = {.entry = {.count = 1, .reusable = false}}, SHIFT(28),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__san_move_pawn, 4),
  [137] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__san_move_pawn, 4),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_san_move, 1),
  [141] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_san_move, 1),
  [143] = {.entry = {.count = 1, .reusable = false}}, SHIFT(40),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__san_move_major_or_minor_piece, 2),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__san_move_major_or_minor_piece, 2),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__lan_move_by_coordinates, 4),
  [151] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__lan_move_by_coordinates, 4),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__san_promotion, 2),
  [155] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__san_promotion, 2),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__san_move_pawn, 2),
  [159] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__san_move_pawn, 2),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__san_move_major_or_minor_piece, 3),
  [163] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__san_move_major_or_minor_piece, 3),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__san_move_major_or_minor_piece, 4),
  [167] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__san_move_major_or_minor_piece, 4),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__san_drop_pawn, 3),
  [171] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__san_drop_pawn, 3),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__san_drop_pawn, 2),
  [175] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__san_drop_pawn, 2),
  ...
  [226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lan_move, 2),
  [228] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lan_move, 2),
  ...
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__movetext_element, 1, .production_id = 8),
  [240] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__movetext_element, 1, .production_id = 8),
  ...
  [300] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_variation_movetext_repeat1, 2, .production_id = 33), SHIFT_REPEAT(134),
  ...
  [312] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_variation_movetext_repeat1, 2, .production_id = 33), SHIFT_REPEAT(131),
  ...
  [388] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_freestanding_comment_repeat1, 2), SHIFT_REPEAT(154),
  ...
  [571] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tagpair_value, 2, .production_id = 29),
